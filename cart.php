...
<head>
  ...
  <script>window.VIEW = "CART";</script>
...
<body>
  ...
  <div id="modal-div" class="mdc-drawer-app-content mdc-top-app-bar--fixed-adjust">
    <main class="main-content" id="main-content">
      ...
      <button id="confirm-purchase" class="mdc-button mdc-button--raised center-horizontal margin-top-30">
        <span class="mdc-button__ripple"></span>
        <span class="mdc-button__touch"></span>
        <span class="mdc-button__label">CONFIRM PURCHASE</span>
      </button>
